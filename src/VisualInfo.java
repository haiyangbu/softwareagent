...
class VisualInfo
{
	...
	//Goal
	    ...
	    //System.out.println("line created ::::::::::" + objInfo.m_type + 
	    //		",kind:" + ((LineInfo)objInfo).m_kind);
	} //Flag[]
		...
		if(p_type.matcher(objectName[1]).matches()){
			...
			break;
      	    ...
      	    //System.err.println("Obj Info ---- :" + flagType + " [type]" + type + 
      	    //		" [pos1:]" + pos1 + " [pos2:]" + pos2 + " [num:]" + num + " [out:]" + out);
